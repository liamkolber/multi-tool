...
// An account's numeric id is permanent, and web_profile_info is the endpoint
// Instagram throttles first. Remembering the answer turns every later story
// fetch for the same account into one request instead of two.
